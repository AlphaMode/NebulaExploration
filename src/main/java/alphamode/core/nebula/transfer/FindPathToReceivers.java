...
public class FindPathToReceivers {
    ...
    private boolean isValidEndpoint(World world, BlockPos pos, BlockPos previousPos) {
        ...
        return world.getBlockState(pos).contains(Util.getSideFromDirection(direction)) && world.getBlockState(pos).get(Util.getSideFromDirection(direction)).equals(Side.IN);
