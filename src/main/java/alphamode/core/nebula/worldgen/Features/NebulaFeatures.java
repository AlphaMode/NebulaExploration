...
public class NebulaFeatures {
    ...
    static {
        ALUMINUM_ORE = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, NebulaBlocks.ALUMINUM_ORE.getDefaultState(), 5)).repeat(10).spreadHorizontally();
    }
}
